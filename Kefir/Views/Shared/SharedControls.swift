...
#Preview("Modern Slider") {
    @State var value: Double = 50
    @State var isDragging = false
    
    return ModernSlider(value: $value, isDragging: $isDragging)
        .padding()
        .frame(width: 300)
}
...
#Preview("Control Buttons") {
    HStack(spacing: 20) {
        ControlButton(icon: "minus", action: {})
        ControlButton(icon: "speaker.fill", isLarge: true, action: {})
        ControlButton(icon: "speaker.slash.fill", isLarge: true, isAccent: true, action: {})
        ControlButton(icon: "plus", action: {})
    }
    .padding()
}
...
#Preview("Play Buttons") {
    HStack(spacing: 20) {
        PlayButton(icon: "backward.fill", size: .small, action: {})
        PlayButton(icon: "play.fill", size: .large, action: {})
        PlayButton(icon: "pause.fill", size: .large, action: {})
        PlayButton(icon: "forward.fill", size: .small, action: {})
    }
    .padding()
}
...
#Preview("Album Art") {
    HStack(spacing: 20) {
        AlbumArtView(coverURL: nil)
        AlbumArtView(coverURL: "https://example.com/album.jpg")
    }
    .padding()
}